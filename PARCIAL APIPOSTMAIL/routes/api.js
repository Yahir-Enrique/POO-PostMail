...
//ANTES: Se manejaban "envíos disponibles" para calcular el sistema de uso.
//AHORA: Se usa un sistema basado en "créditos", donde cada acción afecta el saldo disponible del usuario.
//IMPORTANTE: Los envíos ahora tienen un costo en créditos, y el usuario debe tener saldo suficiente para procesarlos.
//CUANDO SE ELIMINA UN ENVÍO: Se reembolsa una cantidad de créditos dependiendo del peso y bultos del producto.
